...
export default function ShowClothes({ clothing, handleEditClothesClick, handleDeleteClothesClick, handleAddTagsClick, selectedTags, setSelectedTags }) {
	...
	return (
		<div
			className="border-4 border-b-black border-l-black h-[400px] w-[300px] bg-white dark:rounded-lg dark:border-slate-800 dark:border-4 dark:bg-slate-300"
		>
			<div
			...
			<div className="text-black font-press-start text-[18px] mb-2 dark:font-sans dark:text-2xl dark:text-slate-800 dark:font-bold dark:mb-1">
				{clothing.clothesName}
			</div>
			<div className="text-black font-press-start text-[12px] dark:font-sans dark:text-[16px] dark:text-slate-800">
